...
# Ensure compdef is available (for standalone usage outside of Oh My Zsh)
if ! command -v compdef >/dev/null 2>&1; then
  # Define a no-op compdef if it doesn't exist
  compdef() { : }
fi

# Define git_current_branch if not already defined
